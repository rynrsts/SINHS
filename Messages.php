		...
		<div class="container-fluid">
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> User Messages</div>
				<div class="card-body">
							...
							<tbody>
								<form method="post" action="Messages.php">
									...
									<?php
										...
										$sqlView = "SELECT * FROM tbl_contact";
...
<?php
	...
	if (isset($_POST['delete'])) {
		...
		if (isset($_POST['check'])) {
			...
			for ($i = 0; $i < $cntRec; $i++) {
				$delID = $delRec[$i];
				$sqlDelete = "DELETE FROM tbl_contact WHERE id = $delID";
				mysqli_query($link, $sqlDelete);

				$forAlert = true;
			}
			if ($forAlert == true) {
				echo "<script>alert('The message/s has/have been deleted.')</script>";
