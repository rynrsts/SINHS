		...
		<div class="container-fluid">
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> User Account Lists and Data</div>
				<div class="card-body">
							...
							<tbody>
								<form method="post" action="Accounts.php">
									...
									<?php
										...
										$sqlView = "SELECT * FROM tbl_register";
										...
										while ($row = mysqli_fetch_array($result)) {
											echo "<tr>
												...
												<td>" . $row['username'] . "</td>
												<td>" . $row['password'] . "</td>
												<td><a class=editdelete href=EditAcc.php?=$row[id]> &#9997; </a></td>
											</tr>";
										}
									?>
...
<?php
	...
	if (isset($_POST['delete'])) {
		...
		if (isset($_POST['check'])) {
			...
			for ($i = 0; $i < $cntRec; $i++) {
				$delID = $delRec[$i];
				$sqlDelete = "DELETE FROM tbl_register WHERE id = $delID";
